            ...
            <div className="border-b border-white/10 bg-gradient-to-b from-white/[0.04] to-transparent px-8 py-7">
              <div className="flex items-start justify-between gap-6">
                ...
                <button
                  ...
                  className="group flex h-11 w-11 items-center justify-center rounded-2xl border border-red-500/20 bg-red-500/10 text-red-400 transition-all hover:scale-105 hover:bg-red-500/20"
                >
                  <Trash2
                    size={18}
                  ...
                  <div className="rounded-2xl border border-white/5 bg-white/[0.03] p-4">
                    ...
                    <span
                      className={`inline-flex rounded-xl px-3 py-1.5 text-xs font-semibold ${
                        PRIORITY_CONFIG[displayed.priority].bg
